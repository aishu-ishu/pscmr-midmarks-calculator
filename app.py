...
def process_image():
    ...
    try:
        ...
        # SINGLE-PASS OCR: Run Tesseract once for the entire image
        ocr_data = pytesseract.image_to_data(
            pil_img, output_type=pytesseract.Output.DICT, config="--oem 1 --psm 6"
        )
        ...
        # Map words to grid cells instantly in memory
        extracted_grid = []
        for r in grid_rows:
            row_texts = []
            for x, y, w, h in r:
